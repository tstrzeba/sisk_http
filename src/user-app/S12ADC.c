...
/*******************************************************************************
* Function name: S12ADC_read_temperature
* Description  : Reads the results register for internal temperature sensor channel of the S12ADC
* Arguments    : none
* Return value : uint16_t - The ADC conversion value.
*******************************************************************************/
uint32_t S12ADC_read_temperature() {
	    ...
	    */
	    S12AD.ADANS0.WORD = 0x0000; /* Read AN002, which is connected to the potentiometer */
	   ...
	   // S12AD.ADSTRGR.BYTE = 0x00;
	    ...
	    /* Read the result */
	    return S12AD.ADTSDR;
} /* End of function S12ADC_read_temperature() */

/*******************************************************************************
* Function name: S12ADC_read_potentiometer
* Description  : Reads the results register for channel AN002 of the S12ADC
* Arguments    : none
* Return value : uint16_t - The ADC conversion value.
*******************************************************************************/
uint16_t S12ADC_read_potentiometer() {
	/* ADCSR: A/D Control Register
	    b7    ADST     0 a/d conversion start, Stop a scan conversion process
	    b6    ADCS     0 Scan mode select, Single-scan mode
	    b5    Reserved 0 This bit is always read as 0. The write value should always be 0.
	    ...
	    */
	    ...
	    /* Read the result */
	    return S12AD.ADDR2;
} /* End of function S12ADC_read_potentiometer() */
