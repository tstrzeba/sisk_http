...
int32_t R_Ether_Open(uint32_t ch, uint8_t mac_addr[])
{
    ...
    EDMAC.RDLAR  = (unsigned long)le0.rxcurrent;   /* initialize Rx Descriptor List Address */
    EDMAC.TDLAR  = (unsigned long)le0.txcurrent;   /* initialize Tx Descriptor List Address */
